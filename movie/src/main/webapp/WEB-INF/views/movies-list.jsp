        ...
        <section class="section-long">
            <div class="container">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Watchers</a>
                        </h4>
                        <div class="entity-category">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Iron planet</a>
                        </h4>
                        <div class="entity-category">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Monday invasion</a>
                        </h4>
                        <div class="entity-category">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Dady is back</a>
                        </h4>
                        <div class="entity-category">
                            <a class="content-link" href="movies-blocks.html">drama</a>,
                            <a class="content-link" href="movies-blocks.html">comedy</a>
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Deadman skull</a>
                        </h4>
                        <div class="entity-category">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Fall</a>
                        </h4>
                        <div class="entity-category">
                            <a class="content-link" href="movies-blocks.html">drama</a>,
                            <a class="content-link" href="movies-blocks.html">melodrama</a>
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">High castle</a>
                        </h4>
                        <div class="entity-category">
                ...
                <article class="movie-line-entity">
                    ...
                    <div class="entity-content">
                        <h4 class="entity-title">
                            <a class="content-link" href="movie-info-sidebar-right.jsp">Music town</a>
                        </h4>
                        <div class="entity-category">
                            <a class="content-link" href="movies-blocks.html">adventure</a>
                        </div>
