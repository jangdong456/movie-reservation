                ...
                <div class="content">
                    <section class="section-long">
                        ...
                        <div class="section-line">
                                    ...
                                    <div class="gallery-card-entity">
                                        <div class="entity-preview" data-role="hover-wrap">
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <img class="embed-responsive-item" src="http://placehold.com/1920x1080" alt="" />
                                            </div>
                                            <div class="d-over bg-black-40 collapse animated faster" data-show-class="fadeIn show" data-hide-class="fadeOut show">
                                                <div class="entity-view-popup">
                                                    <a class="content-link action-icon-bordered rounded-circle" href="http://placehold.com/1920x1080" data-magnific-popup="image">
                            ...
                            <div class="section-bottom">
                                <a class="btn btn-theme" href="gallery.jsp">View All</a>
                            </div>
                        </div>
                        <div class="section-line">
                            <div class="section-head">
                ...
                <div class="sidebar section-long order-lg-last">
                    ...
                    <section class="section-sidebar">
                        <a class="d-block" href="#">
                            <img class="w-100" src="http://placehold.com/350x197" alt="" />
                        </a>
                    </section>
                </div>
            </div>
