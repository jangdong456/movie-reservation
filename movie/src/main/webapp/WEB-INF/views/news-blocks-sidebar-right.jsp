        ...
        <section class="after-head d-flex section-text-white position-relative">
            ...
            <div class="top-block top-inner container">
                <div class="top-block-content">
                    <h1 class="section-title">News blocks</h1>
                        ...
                        <article class="article-tape-entity">
                            <a class="entity-preview" href="article-sidebar-right.jsp" data-role="hover-wrap">
                                <span class="embed-responsive embed-responsive-16by9">
                                    <img class="embed-responsive-item" src="http://placehold.com/720x405" alt="" />
                                </span>
                ...
                <div class="sidebar section-long order-lg-last">
                    <section class="section-sidebar">
                        ...
                        <div class="article-short-line-entity">
                            <a class="entity-preview" href="article-sidebar-right.jsp">
                                <span class="embed-responsive embed-responsive-16by9">
                                    <img class="embed-responsive-item" src="http://placehold.com/720x405" alt="" />
                                </span>
                            </a>
