...
(function (fn) {
    ...
    initMap = function (){
        ...
        var styledMapType = new google.maps.StyledMapType(
            ...
            {name: 'Styled Map'});
        // icon 객체 만드는 함수
        // 주어진 URL을 사용하여 이미지 요소를 생성하고 반환하는 함수
        function createMarkerContent(iconUrl) {
            ...
            // 마커가 잘 보이도록 크기 및 스타일을 지정할 수 있습니다.
            // 필요에 따라 크기를 조정하세요.
            iconImg.style.width = '24px';
            iconImg.style.height = '24px';
            iconImg.style.borderRadius = '50%'; // 예시: 원형 마커
        ...
        $('.gmap').each(function(i, el){
            ...
            const iconUrl = data.marker || "./images/parts/map-marker.png";
            const markerContent = createMarkerContent(iconUrl);
